...
export function DeckDetail({
  ...
  const correctCount = deck.cards.filter(
    (c) => c.lastResult === "correct",
  ).length;
  const incorrectCount = deck.cards.filter(
    (c) => c.lastResult === "incorrect",
  ).length;
  ...
  const statChips = deck.cards.length > 0 && (
    <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
      <Chip
        ...
        size="small"
        onClick={
          activeFilter !== null ? () => setActiveFilter(null) : undefined
        }
  ...
  return (
    ...
    >
              ...
              >
                ...
                <Box sx={{ display: "flex", gap: 0.5 }}>
                  <IconButton
                    ...
                    onClick={() =>
                      openEdit(card.id, card.question, card.answer)
                    }
                    sx={{
      ...
      >
        ...
        <DialogActions
          sx={{ p: isMobile ? 2 : undefined, gap: isMobile ? 1 : undefined }}
        >
          <Button
